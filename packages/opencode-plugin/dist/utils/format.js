...
export function formatHindsightResults(matches) {
    if (matches.length === 0)
...
export function formatAssembledContext(context) {
    const summaryLines = [
