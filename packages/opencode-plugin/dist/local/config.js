...
export const parseLocalConfig = (env = process.env, cwd = process.cwd()) => {
    ...
    const merged = {
        ...
        sync_push_interval_ms: parseInteger(env.AETERNA_LOCAL_SYNC_PUSH_INTERVAL_MS) ??
            fileConfig.sync_push_interval_ms ??
            DEFAULT_LOCAL_CONFIG.sync_push_interval_ms,
        sync_pull_interval_ms: parseInteger(env.AETERNA_LOCAL_SYNC_PULL_INTERVAL_MS) ??
            fileConfig.sync_pull_interval_ms ??
            DEFAULT_LOCAL_CONFIG.sync_pull_interval_ms,
        max_cached_entries: parseInteger(env.AETERNA_LOCAL_MAX_CACHED_ENTRIES) ??
            fileConfig.max_cached_entries ??
            DEFAULT_LOCAL_CONFIG.max_cached_entries,
        session_storage_ttl_hours: parseInteger(env.AETERNA_LOCAL_SESSION_STORAGE_TTL_HOURS) ??
...
const parseLocalConfigToml = (cwd) => {
