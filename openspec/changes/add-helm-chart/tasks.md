...
- [x] 1.1.7 Write unit tests for CLI argument parsing
...
- [x] 1.2.9 Write integration tests for wizard flow
...
- [x] 1.3.3 Add local cache size selector for Hybrid mode
- [x] 1.3.4 Add offline Cedar Agent toggle for Hybrid mode
- [x] 1.3.5 Add sync interval configuration
- [x] 1.3.6 Validate central server connectivity before proceeding
- [x] 1.3.7 Write tests for Hybrid mode configuration
...
- [x] 1.4.5 Add template validation before writing files
- [x] 1.4.6 Add backup of existing files before overwriting
- [x] 1.4.7 Write unit tests for each generator

### 1.5 External Service Prompts
- [x] 1.5.1 Add Pinecone configuration prompts (API key, environment, index name)
- [x] 1.5.2 Add Weaviate configuration prompts (host, API key)
- [x] 1.5.3 Add MongoDB Atlas configuration prompts (connection URI)
- [x] 1.5.4 Add Vertex AI configuration prompts (project, region, endpoint, service account)
- [x] 1.5.5 Add Databricks configuration prompts (workspace URL, token, catalog)
...
- [x] 1.5.11 Write tests for external service configuration
...
- [x] 2.1.6 Add chart versioning strategy documentation
...
- [x] 2.2.6 Add resource calculation helpers
- [x] 2.2.7 Add validation helpers (mutual exclusivity checks)
...
- [x] 3.5.3 Add VPA support (VerticalPodAutoscaler template)

### 3.6 Database Migrations
- [x] 3.6.1 Create `templates/aeterna/job-migration.yaml` for schema migrations
- [x] 3.6.2 Add pre-upgrade hook for migrations
- [x] 3.6.3 Add migration job cleanup policy
...
- [x] 5.1.3 Configure cluster creation template
- [x] 5.1.4 Add pgvector extension installation
- [x] 5.1.5 Configure backup to S3/GCS/Azure
- [x] 5.1.6 Add conditional logic for external PostgreSQL
- [x] 5.1.7 Document CloudNativePG upgrade procedure

### 5.2 Dragonfly (Redis-Compatible Cache)
- [x] 5.2.1 Add Dragonfly operator as subchart dependency
- [x] 5.2.2 Pin to specific version
- [x] 5.2.3 Configure Dragonfly instance template
- [x] 5.2.4 Add HA configuration (master/replica)
- [x] 5.2.5 Add conditional logic for external Redis

### 5.3 Valkey (Alternative Redis)
- [x] 5.3.1 Add Valkey as subchart dependency
- [x] 5.3.2 Pin to specific version
- [x] 5.3.3 Configure Valkey instance template
...
- [x] 5.4.3 Configure distributed deployment (3+ nodes for production)
- [x] 5.4.4 Add snapshot/backup configuration
...
- [x] 5.5.3 Configure multi-tenancy settings
...
- [x] 5.6.3 Configure replica set with Atlas Search
...
- [x] 6.1.4 Document local mode limitations

### 6.2 Hybrid Mode
- [x] 6.2.1 Create values-hybrid.yaml with local cache only
- [x] 6.2.2 Add central server connection configuration
- [x] 6.2.3 Configure sync service settings
- [x] 6.2.4 Enable local Cedar Agent for offline policy evaluation
- [x] 6.2.5 Configure memory layer sync (Working/Session → Episodic)
- [x] 6.2.6 Document hybrid mode architecture and data flow

### 6.3 Remote Mode
- [x] 6.3.1 Create values-remote.yaml with thin client configuration
- [x] 6.3.2 Disable all local storage components
- [x] 6.3.3 Configure central server authentication
- [x] 6.3.4 Document remote mode requirements
...
- [x] 7.1.2 Add metrics port configuration
- [x] 7.1.3 Add scrape interval and timeout settings
- [x] 7.1.4 Add conditional rendering (when serviceMonitor.enabled=true)

### 7.2 Tracing
- [x] 7.2.1 Add OpenTelemetry configuration to deployment
- [x] 7.2.2 Configure tracing endpoint environment variable
- [x] 7.2.3 Document Jaeger/Tempo integration

### 7.3 Logging
- [x] 7.3.1 Configure structured JSON logging
- [x] 7.3.2 Add log level configuration per component
- [x] 7.3.3 Document log aggregation setup (Loki, ELK)
...
- [x] 8.2.1 Create values-sops.yaml example
- [x] 8.2.2 Document SOPS with age/GPG keys setup
- [x] 8.2.3 Add helm-secrets plugin documentation

### 8.3 External Secrets Operator
- [x] 8.3.1 Create `templates/externalsecret.yaml` template
- [x] 8.3.2 Add secretProvider configuration option
- [x] 8.3.3 Document AWS Secrets Manager integration
- [x] 8.3.4 Document HashiCorp Vault integration
- [x] 8.3.5 Document Azure Key Vault integration
...
### 9.1 Security
- [x] 9.1.1 Add Pod Security Standards (restricted profile)
- [x] 9.1.2 Configure network policies for all components
- [x] 9.1.3 Add image pull secrets configuration
- [x] 9.1.4 Document security best practices

### 9.2 High Availability
- [x] 9.2.1 Configure pod anti-affinity for all stateless components
- [x] 9.2.2 Add topology spread constraints
- [x] 9.2.3 Configure PDB for all critical components
- [x] 9.2.4 Document HA requirements (min 3 nodes)

### 9.3 Resource Management
- [x] 9.3.1 Create values-small.yaml (< 1000 memories)
- [x] 9.3.2 Create values-medium.yaml (< 100k memories)
- [x] 9.3.3 Create values-large.yaml (> 100k memories)
- [x] 9.3.4 Add sizing guide documentation

### 9.4 Backup and Recovery
- [x] 9.4.1 Create backup CronJob template for PostgreSQL
- [x] 9.4.2 Add S3/GCS/Azure backup destination configuration
- [x] 9.4.3 Document restore procedure
- [x] 9.4.4 Add backup verification job
...
- [x] 10.1.3 Write connection test for Redis/Dragonfly
...
- [x] 10.2.1 Test Local mode deployment (all bundled)
- [x] 10.2.2 Test Hybrid mode deployment
- [x] 10.2.3 Test Remote mode deployment
- [x] 10.2.4 Test with external dependencies only
- [x] 10.2.5 Test mixed configuration (some bundled, some external)

### 10.3 CLI Testing
- [x] 10.3.1 Write unit tests for wizard flow logic
- [x] 10.3.2 Write unit tests for configuration generators
- [x] 10.3.3 Write integration tests for file generation
- [x] 10.3.4 Write E2E test for full wizard → deploy cycle
...
- [x] 11.2.1 Create Local mode quick start guide
- [x] 11.2.2 Create Hybrid mode deployment guide
- [x] 11.2.3 Create Remote mode deployment guide
- [x] 11.2.4 Create production deployment checklist
...
- [x] 11.3.4 Create values-aws.yaml example (EKS-specific)
- [x] 11.3.5 Create values-gke.yaml example (GKE-specific)
- [x] 11.3.6 Create values-aks.yaml example (AKS-specific)

### 11.4 Upgrade Documentation
- [x] 11.4.1 Document chart upgrade procedure
- [x] 11.4.2 Add version migration notes
- [x] 11.4.3 Document subchart upgrade process
- [x] 11.4.4 Add rollback procedure
