...
The system SHALL support multiple knowledge layers (Company, Org, Team, Project) with explicit precedence rules.

#### Scenario: Project-specific override
- **WHEN** a Project-level policy conflicts with a Company-level policy
- **THEN** the Project-level policy SHALL take precedence during evaluation
