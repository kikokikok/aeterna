//! # GrepAI Type Definitions
//!
//! Types for GrepAI requests and responses.
...
/// GrepAI MCP request structure (for proxying)
#[derive(Serialize, Deserialize, Debug)]
pub struct GrepAIRequest {
    /// Tool name (grepai_search, grepai_trace_callers, etc.)
    pub tool: String,
    /// Tool parameters
    pub params: Value,
}

/// GrepAI MCP response structure (for proxying)
#[derive(Serialize, Deserialize, Debug)]
pub struct GrepAIResponse {
    /// Success flag
    pub success: bool,
    /// Response data
    #[serde(skip_serializing_if = "Option::is_none")]
