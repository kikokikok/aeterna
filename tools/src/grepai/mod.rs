//! # GrepAI Integration Module
//!
//! Provides MCP tools for semantic code search and call graph analysis via GrepAI sidecar.
//!
//! ## Architecture
//! - `client`: MCP client for communicating with GrepAI sidecar
